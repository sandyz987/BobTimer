...
open class LikeView @JvmOverloads constructor(
    ...
    init {
        val typedArray =
            context.obtainStyledAttributes(attrs, R.styleable.community_LikeView)

        paint = Paint()
        paint.isAntiAlias = true
        paint.color = Color.GRAY
        s = typedArray.getString(R.styleable.community_LikeView_community_like_count_text)
        endSrcId = typedArray.getResourceId(R.styleable.community_LikeView_community_liked_src, 0)
        startSrcId = typedArray.getResourceId(R.styleable.community_LikeView_community_no_liked_src, 0)
        typedArray.recycle()
