...
class CommentCountView @JvmOverloads constructor(
    ...
    init {
        val typedArray = context.obtainStyledAttributes(attrs, R.styleable.community_CommentCountView)

        paint = Paint()
        paint.isAntiAlias = true
        paint.color = Color.GRAY
        s = typedArray.getString(R.styleable.community_CommentCountView_community_reply_count_text)
        startSrcId = typedArray.getResourceId(R.styleable.community_CommentCountView_community_reply_pic_src, 0)
        typedArray.recycle()
