package com.sandyz.lib_common.extensions
...
//        val bitmap = BitmapFactory.decodeResource(resources, R.drawable.common_ic_background_test, options)
        mSizeFix = bitmap.width.toFloat() / bitmap.height.toFloat()

//        mDrawable = ResourcesCompat.getDrawable(resources, R.drawable.common_ic_background_test, null)
...
//        iv.setImageDrawable(mDrawable)
        ...
        Log.e("sandyzhang", "${(mSizeFix * mHeight).toInt()}, ${mHeight}")
        iv.post {
            Log.e("sandyzhang", "${iv.width},--- ${iv.height}")
